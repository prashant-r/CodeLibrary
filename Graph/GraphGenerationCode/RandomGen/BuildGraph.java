...
public class BuildGraph implements TypedGraphGenerator{
public BuildGraph(String fileName, String directory, int vertices, int dense, int maxCapacity, int minCapacity)
    {
...
public void generateGraph(int n, int m, float maxProbability, int minCapacity, int maxCapacity, String fileName) {
	BuildGraph b = new BuildGraph(fileName, "", n, 50, maxCapacity, minCapacity);
}
}